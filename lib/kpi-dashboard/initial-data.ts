import type { DepartmentData, MDComment, MetricStatus } from "./types"
...
export const initialDepartments: DepartmentData[] = [
    ...
    metrics: [
      {
        ...
        chart: {
          points: [
            ...
            { label: "Q2", value: 1950000 },
            { label: "Q3", value: 2200000 },
            { label: "Q4", value: 2450000 },
          ],
        },
      },
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        value: "Moderate",
        status: "amber",
        details: "Set risk per variety on the metric page (Low to Extreme). Headline shows the worst level among rated varieties.",
        comments: [],
        lastUpdated: STATIC_TIMESTAMP,
      },
    ],
    ...
    metrics: [
      {
        ...
        trend: "stable",
        details:
          "Tonnes received by variety are entered on the metric page (monthly grid). The headline shows the variety most recently saved and its year-to-date cumulative tonnes.",
        comments: [],
        lastUpdated: STATIC_TIMESTAMP,
      },
      {
  ...
  },
  {
    ...
    metrics: [
      {
        id: "legal-contracts",
        name: "Active Contracts Reviewed",
        value: 42,
        unit: "contracts",
        target: 50,
        status: "amber",
