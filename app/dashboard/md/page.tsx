...
import { Lock, FileText, CheckCircle2, Download, Eye } from "lucide-react"
...
export default async function MDDashboardPage() {
  ...
  // Fetch confidential audit reports (only visible to MD and BOOTSTRAP_ADMIN)
        ...
        <TabsContent value="confidential" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Reports visible only to Managing Director</CardDescription>
            </CardHeader>
            <CardContent>
