...
import { Lock, FileText, Download, Eye, Crown, CheckCircle2 } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Confidential audit reports and MD-only oversight</p>
        </div>
